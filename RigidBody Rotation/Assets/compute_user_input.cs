...
public class compute_user_input : MonoBehaviour {
	...
	void Start () {
		...
		Vector3 target = transform(r1, r2, p1, p1p, p5);
		print(target[0].ToString("F10"));
		print(target[1].ToString("F10"));
		print(target[2].ToString("F10"));
	}
